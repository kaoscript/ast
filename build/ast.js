...
module.exports = function() {
	...
	var Kind = {
		...
		MemberExpression: 49,
		MemberReference: 50,
		MethodAliasDeclaration: 51,
		MethodDeclaration: 52,
		MethodLinkDeclaration: 53,
		MixinDeclaration: 54,
		Module: 55,
		...
		ObjectExpression: 58,
		ObjectMember: 59,
		OmittedExpression: 60,
		Parameter: 61,
		PolyadicOperator: 62,
		RegularExpression: 63,
		RequireDeclaration: 64,
		RequireOrExternDeclaration: 65,
		ReturnStatement: 66,
		SurrogateDeclaration: 67,
		SwitchClause: 68,
		SwitchConditionArray: 69,
		SwitchConditionEnum: 70,
		SwitchConditionObject: 71,
		SwitchConditionRange: 72,
		SwitchConditionType: 73,
		SwitchExpression: 74,
		SwitchStatement: 75,
		SwitchTypeCast: 76,
		TemplateExpression: 77,
		TernaryConditionalExpression: 78,
		ThrowStatement: 79,
		TraitDeclaration: 80,
		TryStatement: 81,
		TypeAliasDeclaration: 82,
		TypeReference: 83,
		UnaryExpression: 84,
		UnlessExpression: 85,
		UnlessStatement: 86,
		...
		VariableDeclarator: 90,
		VariableExpression: 91,
		WhileStatement: 92
	};
	var MemberModifier = {
		Private: 2,
