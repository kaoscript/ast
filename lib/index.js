...
module.exports = function() {
	const __ksType = {
		...
		isNodeData: (value, cast, filter) => __ksType.isRange(value) && Type.isDexObject(value, 1, 0, {kind: variant => {
			...
			if(variant === NodeKind.ArrayComprehension) {
				return Type.isDexObject(value, 0, 0, {modifiers: value => Type.isArray(value, value => __ksType.isModifierData(value, cast)), expression: value => __ksType.isNodeData(value, cast, NodeKind.__ks_eq_Expression), loop: value => __ksType.isNodeData(value, cast, value => value === NodeKind.ForStatement || value === NodeKind.RepeatStatement)});
			}
		...
		isAssignmentOperatorKind: value => value === OperatorKind.Addition || value === OperatorKind.BitwiseAnd || value === OperatorKind.BitwiseOr || value === OperatorKind.BitwiseXor || value === OperatorKind.BitwiseLeftShift || value === OperatorKind.BitwiseRightShift || value === OperatorKind.Division || value === OperatorKind.Empty || value === OperatorKind.EmptyCoalescing || value === OperatorKind.Equals || value === OperatorKind.Existential || value === OperatorKind.LogicalAnd || value === OperatorKind.LogicalImply || value === OperatorKind.LogicalOr || value === OperatorKind.LogicalXor || value === OperatorKind.Modulo || value === OperatorKind.Multiplication || value === OperatorKind.NonEmpty || value === OperatorKind.NonExistential || value === OperatorKind.NullCoalescing || value === OperatorKind.Quotient || value === OperatorKind.Return || value === OperatorKind.Subtraction,
		isBinaryOperatorKind: value => value === OperatorKind.Addition || value === OperatorKind.Assignment || value === OperatorKind.BackwardPipeline || value === OperatorKind.BitwiseAnd || value === OperatorKind.BitwiseOr || value === OperatorKind.BitwiseXor || value === OperatorKind.BitwiseLeftShift || value === OperatorKind.BitwiseRightShift || value === OperatorKind.Division || value === OperatorKind.Empty || value === OperatorKind.EmptyCoalescing || value === OperatorKind.Equality || value === OperatorKind.Equals || value === OperatorKind.Existential || value === OperatorKind.ForwardPipeline || value === OperatorKind.GreaterThan || value === OperatorKind.GreaterThanOrEqual || value === OperatorKind.Inequality || value === OperatorKind.JunctionAnd || value === OperatorKind.JunctionOr || value === OperatorKind.JunctionXor || value === OperatorKind.LessThan || value === OperatorKind.LessThanOrEqual || value === OperatorKind.LogicalAnd || value === OperatorKind.LogicalImply || value === OperatorKind.LogicalOr || value === OperatorKind.LogicalXor || value === OperatorKind.Match || value === OperatorKind.Mismatch || value === OperatorKind.Modulo || value === OperatorKind.Multiplication || value === OperatorKind.NonEmpty || value === OperatorKind.NonExistential || value === OperatorKind.NullCoalescing || value === OperatorKind.Quotient || value === OperatorKind.Return || value === OperatorKind.Subtraction || value === OperatorKind.TypeCasting || value === OperatorKind.TypeEquality || value === OperatorKind.TypeInequality,
		isUnaryOperatorKind: value => value === OperatorKind.BitwiseNegation || value === OperatorKind.Constant || value === OperatorKind.Existential || value === OperatorKind.Implicit || value === OperatorKind.LogicalNegation || value === OperatorKind.Negative || value === OperatorKind.NonEmpty || value === OperatorKind.Spread || value === OperatorKind.TypeFitting,
	...
	const OperatorKind = Helper.enum(Number, 2, "attribute", "precedence", "Addition", 1, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 13, "Assignment", 2, OperatorAttribute.Binary, 3, "BackwardPipeline", 3, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.RTL), 20, "BitwiseAnd", 4, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 12, "BitwiseNegation", 5, OperatorAttribute.Unary, 0, "BitwiseOr", 6, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 12, "BitwiseXor", 7, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 12, "BitwiseLeftShift", 8, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 12, "BitwiseRightShift", 9, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 12, "Constant", 10, OperatorAttribute.Unary, 0, "Division", 11, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 14, "Empty", 12, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Assignable), 0, "EmptyCoalescing", 13, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 15, "Equality", 14, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Comparable), 8, "Equals", 15, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Assignable), 0, "Existential", 16, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Assignable | OperatorAttribute.Unary), 0, "ForwardPipeline", 17, OperatorAttribute.Binary, 16, "GreaterThan", 18, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Comparable), 8, "GreaterThanOrEqual", 19, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Comparable), 8, "Implicit", 20, OperatorAttribute.Unary, 0, "Inequality", 21, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Comparable), 8, "JunctionAnd", 22, OperatorAttribute.Binary, 0, "JunctionOr", 23, OperatorAttribute.Binary, 0, "JunctionXor", 24, OperatorAttribute.Binary, 0, "LessThan", 25, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Comparable), 8, "LessThanOrEqual", 26, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Comparable), 8, "LogicalAnd", 27, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 6, "LogicalImply", 28, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 5, "LogicalNegation", 29, OperatorAttribute.Unary, 0, "LogicalOr", 30, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 5, "LogicalXor", 31, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 5, "Match", 32, OperatorAttribute.Binary, 8, "Mismatch", 33, OperatorAttribute.Binary, 8, "Modulo", 34, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 14, "Multiplication", 35, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 14, "Negative", 36, OperatorAttribute.Unary, 0, "NonEmpty", 37, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Assignable | OperatorAttribute.Unary), 0, "NonExistential", 38, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Assignable), 0, "NullCoalescing", 39, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 15, "Quotient", 40, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 14, "Return", 41, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Assignable), 0, "Spread", 42, OperatorAttribute.Unary, 0, "Subtraction", 43, OperatorAttribute(OperatorAttribute.Binary | OperatorAttribute.Polyadic | OperatorAttribute.Assignable), 13, "TypeCasting", 44, OperatorAttribute.Binary, 8, "TypeEquality", 45, OperatorAttribute.Binary, 8, "TypeFitting", 46, OperatorAttribute.Unary, 0, "TypeInequality", 47, OperatorAttribute.Binary, 8);
