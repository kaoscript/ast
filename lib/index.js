...
module.exports = function() {
	const __ksType = {
		...
		isAst: (value, cast, filter) => __ksType.isRange(value) && Type.isDexObject(value, 1, 0, {kind: variant => {
			...
			if(variant === AstKind.SyntimeExpression) {
				return Type.isDexObject(value, 0, 0, {attributes: value => Type.isArray(value, value => __ksType.isAst(value, cast, value => value === AstKind.AttributeDeclaration)), body: value => __ksType.isAst(value, cast, value => value === AstKind.Block || AstKind.__ks_eq_Statement(value))});
			}
			if(variant === AstKind.SyntimeFunctionDeclaration) {
		...
		isQuoteElementData: (value, cast, filter) => __ksType.isRange(value) && Type.isDexObject(value, 1, 0, {kind: variant => {
			...
			if(variant === QuoteElementKind.Expression) {
				return Type.isDexObject(value, 0, 0, {expression: value => __ksType.isAst(value, cast, AstKind.__ks_eq_Expression), reification: value => __ksType.isReificationData(value, cast) || Type.isNull(value), separator: value => __ksType.isAst(value, cast, AstKind.__ks_eq_Expression) || Type.isNull(value)});
			}
	...
	const AstKind = Helper.enum(Number, 0, "AccessorDeclaration", 1, "ArrayBinding", 2, "ArrayComprehension", 3, "ArrayExpression", 4, "ArrayRange", 5, "ArrayType", 6, "AttributeDeclaration", 7, "AttributeExpression", 8, "AttributeOperation", 9, "AwaitExpression", 10, "BinaryExpression", 11, "BindingElement", 12, "BitmaskDeclaration", 13, "BitmaskValue", 14, "Block", 15, "BlockStatement", 16, "BreakStatement", 17, "CallExpression", 18, "CatchClause", 19, "ClassDeclaration", 20, "CommentBlock", 21, "CommentLine", 22, "ComparisonExpression", 23, "ComputedPropertyName", 24, "ContinueStatement", 25, "CurryExpression", 26, "DeclarationSpecifier", 27, "DiscloseDeclaration", 28, "DisruptiveExpression", 29, "DoUntilStatement", 30, "DoWhileStatement", 31, "EnumDeclaration", 32, "EnumValue", 33, "ExclusionType", 34, "ExportDeclaration", 35, "ExternDeclaration", 36, "ExternOrImportDeclaration", 37, "ExternOrRequireDeclaration", 38, "ExpressionStatement", 39, "FallthroughStatement", 40, "FieldDeclaration", 41, "ForStatement", 42, "FunctionDeclaration", 43, "FunctionExpression", 44, "FusionType", 45, "GroupSpecifier", 46, "Identifier", 47, "IfExpression", 48, "IfStatement", 49, "ImplementDeclaration", 50, "ImportDeclaration", 51, "ImportDeclarator", 52, "IncludeAgainDeclaration", 53, "IncludeDeclaration", 54, "IncludeDeclarator", 55, "JunctionExpression", 56, "LambdaExpression", 57, "Literal", 58, "MatchClause", 59, "MatchConditionArray", 60, "MatchConditionObject", 61, "MatchConditionRange", 62, "MatchConditionType", 63, "MatchExpression", 64, "MatchStatement", 65, "MemberExpression", 66, "MethodDeclaration", 67, "MixinDeclaration", 68, "Module", 69, "MutatorDeclaration", 70, "NamedArgument", 71, "NamedSpecifier", 72, "NamespaceDeclaration", 73, "NumericExpression", 74, "ObjectBinding", 75, "ObjectComprehension", 76, "ObjectExpression", 77, "ObjectMember", 78, "ObjectType", 79, "OmittedExpression", 80, "Operator", 81, "Parameter", 82, "PassStatement", 83, "PlaceholderArgument", 84, "PolyadicExpression", 85, "PositionalArgument", 86, "PropertiesSpecifier", 87, "PropertyDeclaration", 88, "PropertyType", 89, "ProxyDeclaration", 90, "ProxyGroupDeclaration", 91, "QuoteExpression", 92, "Reference", 93, "RegularExpression", 94, "RepeatStatement", 95, "RequireDeclaration", 96, "RequireOrExternDeclaration", 97, "RequireOrImportDeclaration", 98, "RestrictiveExpression", 99, "ReturnStatement", 100, "RollingExpression", 101, "SemtimeStatement", 102, "SequenceExpression", 103, "SetStatement", 104, "ShebangDeclaration", 105, "ShorthandProperty", 106, "SpreadExpression", 107, "StatementList", 108, "StructDeclaration", 109, "SurrogateDeclaration", 110, "SyntimeCallExpression", 111, "SyntimeExpression", 112, "SyntimeFunctionDeclaration", 113, "TaggedTemplateExpression", 114, "TemplateExpression", 115, "ThisExpression", 116, "ThrowStatement", 117, "TopicReference", 118, "TraitDeclaration", 119, "TryExpression", 120, "TryStatement", 121, "TupleDeclaration", 122, "TupleField", 123, "TypeAliasDeclaration", 124, "TypeList", 125, "TypeParameter", 126, "TypeReference", 127, "TypedExpression", 128, "TypedSpecifier", 129, "UnaryExpression", 130, "UnaryTypeExpression", 131, "UnlessStatement", 132, "UntilStatement", 133, "UnionType", 134, "VariableDeclaration", 135, "VariableDeclarator", 136, "VariableStatement", 137, "VariantDeclaration", 138, "VariantField", 139, "VariantType", 140, "WhileStatement", 141, "WithStatement", 142);
	...
	AstKind.__ks_eq_SpecialDeclaration = value => value === AstKind.BitmaskDeclaration || value === AstKind.ClassDeclaration || value === AstKind.EnumDeclaration || value === AstKind.FunctionDeclaration || value === AstKind.NamespaceDeclaration || value === AstKind.StructDeclaration || value === AstKind.SyntimeFunctionDeclaration || value === AstKind.TupleDeclaration || value === AstKind.TypeAliasDeclaration || value === AstKind.VariableStatement;
	AstKind.__ks_eq_DescriptiveType = value => value === AstKind.BitmaskDeclaration || value === AstKind.ClassDeclaration || value === AstKind.EnumDeclaration || value === AstKind.FunctionDeclaration || value === AstKind.NamespaceDeclaration || value === AstKind.StructDeclaration || value === AstKind.SyntimeFunctionDeclaration || value === AstKind.TupleDeclaration || value === AstKind.TypeAliasDeclaration || value === AstKind.VariableStatement || value === AstKind.ExportDeclaration || value === AstKind.VariableDeclarator;
	...
	const QuoteElementKind = Helper.enum(Number, 0, "Expression", 1, "Literal", 2, "NewLine", 3);
