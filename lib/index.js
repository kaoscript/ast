...
module.exports = function() {
	const __ksType = {
		...
		isNodeData: (value, cast, filter) => __ksType.isRange(value) && Type.isDexObject(value, 1, 0, {kind: variant => {
			...
			if(variant === NodeKind.ArrayComprehension) {
				return Type.isDexObject(value, 0, 0, {modifiers: value => Type.isArray(value, value => __ksType.isModifierData(value, cast)), value: value => __ksType.isNodeData(value, cast, NodeKind.__ks_eq_Expression), loop: value => __ksType.isNodeData(value, cast, value => value === NodeKind.ForStatement || value === NodeKind.RepeatStatement)});
			}
		...
		isUnaryOperatorKind: value => value === OperatorKind.BitwiseNegation || value === OperatorKind.Constant || value === OperatorKind.Existential || value === OperatorKind.Finite || value === OperatorKind.Implicit || value === OperatorKind.Length || value === OperatorKind.LogicalNegation || value === OperatorKind.Negative || value === OperatorKind.NonEmpty || value === OperatorKind.Spread || value === OperatorKind.TypeFitting || value === OperatorKind.VariantYes,
	...
	const NodeKind = Helper.enum(Number, 0, "AccessorDeclaration", 1, "ArrayBinding", 2, "ArrayComprehension", 3, "ArrayExpression", 4, "ArrayRange", 5, "ArrayType", 6, "AttributeDeclaration", 7, "AttributeExpression", 8, "AttributeOperation", 9, "AwaitExpression", 10, "BinaryExpression", 11, "BindingElement", 12, "BitmaskDeclaration", 13, "BitmaskValue", 14, "Block", 15, "BlockStatement", 16, "BreakStatement", 17, "CallExpression", 18, "CatchClause", 19, "ClassDeclaration", 20, "CommentBlock", 21, "CommentLine", 22, "ComparisonExpression", 23, "ComputedPropertyName", 24, "ConditionalExpression", 25, "ContinueStatement", 26, "CurryExpression", 27, "DeclarationSpecifier", 28, "DiscloseDeclaration", 29, "DisruptiveExpression", 30, "DoUntilStatement", 31, "DoWhileStatement", 32, "EnumDeclaration", 33, "EnumValue", 34, "ExclusionType", 35, "ExportDeclaration", 36, "ExternDeclaration", 37, "ExternOrImportDeclaration", 38, "ExternOrRequireDeclaration", 39, "ExpressionStatement", 40, "FallthroughStatement", 41, "FieldDeclaration", 42, "ForStatement", 43, "FunctionDeclaration", 44, "FunctionExpression", 45, "FusionType", 46, "GroupSpecifier", 47, "Identifier", 48, "IfExpression", 49, "IfStatement", 50, "ImplementDeclaration", 51, "ImportDeclaration", 52, "ImportDeclarator", 53, "IncludeAgainDeclaration", 54, "IncludeDeclaration", 55, "IncludeDeclarator", 56, "JunctionExpression", 57, "LambdaExpression", 58, "Literal", 59, "MacroDeclaration", 60, "MacroExpression", 61, "MatchClause", 62, "MatchConditionArray", 63, "MatchConditionObject", 64, "MatchConditionRange", 65, "MatchConditionType", 66, "MatchExpression", 67, "MatchStatement", 68, "MemberExpression", 69, "MethodDeclaration", 70, "MixinDeclaration", 71, "Module", 72, "MutatorDeclaration", 73, "NamedArgument", 74, "NamedSpecifier", 75, "NamespaceDeclaration", 76, "NumericExpression", 77, "ObjectBinding", 78, "ObjectComprehension", 79, "ObjectExpression", 80, "ObjectMember", 81, "ObjectType", 82, "OmittedExpression", 83, "Parameter", 84, "PassStatement", 85, "PlaceholderArgument", 86, "PolyadicExpression", 87, "PositionalArgument", 88, "PropertiesSpecifier", 89, "PropertyDeclaration", 90, "PropertyType", 91, "ProxyDeclaration", 92, "ProxyGroupDeclaration", 93, "Reference", 94, "RegularExpression", 95, "RepeatStatement", 96, "RequireDeclaration", 97, "RequireOrExternDeclaration", 98, "RequireOrImportDeclaration", 99, "RestrictiveExpression", 100, "ReturnStatement", 101, "RollingExpression", 102, "SequenceExpression", 103, "SetStatement", 104, "ShebangDeclaration", 105, "ShorthandProperty", 106, "SpreadExpression", 107, "StatementList", 108, "StructDeclaration", 109, "SurrogateDeclaration", 110, "TaggedTemplateExpression", 111, "TemplateExpression", 112, "ThisExpression", 113, "ThrowStatement", 114, "TopicReference", 115, "TraitDeclaration", 116, "TryExpression", 117, "TryStatement", 118, "TupleDeclaration", 119, "TupleField", 120, "TypeAliasDeclaration", 121, "TypeList", 122, "TypeParameter", 123, "TypeReference", 124, "TypedExpression", 125, "TypedSpecifier", 126, "UnaryExpression", 127, "UnaryTypeExpression", 128, "UnlessStatement", 129, "UntilStatement", 130, "UnionType", 131, "VariableDeclaration", 132, "VariableDeclarator", 133, "VariableStatement", 134, "VariantDeclaration", 135, "VariantField", 136, "VariantType", 137, "WhileStatement", 138, "WithStatement", 139);
